...
SYP_DECLARE_SINGLETON(SYPUtility)
@interface SYPUtility(AddPrivateMethod)
+ (NSUInteger) getSysInfo: (uint) typeSpecifier;
@end
@implementation SYPUtility

SYP_IMPLETEMENT_SINGLETON(SYPUtility,defaultUtility)
...
+(NSString *)getIPAddressForHost:(NSString *)theHost{
	...
	if (!host) {
        SYPLOGE("gethostbyname return NULL");
		return NULL;
	}
